...
public class WriteJson {
    public static void main(String[] args) {
        ...
        baithithuchanh.Student student1 = new baithithuchanh.Student("1", "Truong Gia Binh");
        student1.addSubject(new Subject("Math", new int[]{10, 9, 8}));
        student1.addSubject(new Subject("Physics", new int[]{7, 8, 9}));
        students.add(student1);

        baithithuchanh.Student student2 = new baithithuchanh.Student("2", "Le Truong Tung");
